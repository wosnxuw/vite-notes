...
zellij a work / zellij attach work
...
zellij 目前支持了跨平台，它在 Windows 上没问题，在 mac 上，它默认是 Alt+ 左右 切换 Pane，但是 Alt(Opt)+左右 在 mac 上本质是按词移动光标，所以你可以改成 vim 的样子，Alt+hjkl 去切换，但是 mac 可以用鼠标，所以还好

zellij 按三次 ctrl + p + n 新建的面板是左边一个右边三个，你应该 ctrl + p + d 这种给它挪一挪位置
